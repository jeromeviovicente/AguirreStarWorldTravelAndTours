...
public class GenereateCryption {

	public static void genereatecryption(String strDataToEncrypt) throws Exception{
		...
		System.out.println("encrypted value :" + strCipherText);
		...
		System.out.println("decrypted value :" + strDecryptedText);
	}
